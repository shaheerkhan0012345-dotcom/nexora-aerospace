...
function HoverFooter() {
  ...
  return (
    <footer className="bg-[#0F0F11]/10 relative h-fit rounded-3xl overflow-hidden m-8 border border-neutral-800/40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white text-3xl font-bold">Nex/ora</span>
            </div>
            <p className="text-sm leading-relaxed text-neutral-400">
              Nexora is a modern planetary navigation, resource estimation, and deep space exploration platform.
            </p>
          </div>
      ...
      <div className="lg:flex hidden h-[30rem] -mt-52 -mb-36">
        <TextHoverEffect text="Nexora" className="z-50" />
      </div>
